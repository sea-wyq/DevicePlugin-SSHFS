...
func (*FuseDevicePlugin) GetPreferredAllocation(context.Context, *pluginapi.PreferredAllocationRequest) (*pluginapi.PreferredAllocationResponse, error) {
...
func dial(unixSocketPath string, timeout time.Duration) (*grpc.ClientConn, error) {
	dialer := func(ctx context.Context, addr string) (net.Conn, error) {
		return (&net.Dialer{Timeout: timeout}).DialContext(ctx, "unix", addr)
	}
	c, err := grpc.DialContext(context.Background(), unixSocketPath,
		grpc.WithInsecure(),
		grpc.WithBlock(),
